...
public class WeaponAttack : MonoBehaviour, IPauseHandler
{
    ...
    public void ApplyCooldownAttackEffect(float multiplier, float duration, Color boostEffectColor)
    {
        ...
        StartCoroutine(ResetCooldownattackAfterDelay(duration, originalCooldownAttack));
    }

    private IEnumerator ResetCooldownattackAfterDelay(float duration, float cooldownAttack)
    {
